...
const VARIANT_ORDER = ['base', 'gold', 'gummy', 'galaxy', 'holofoil', 'cube', 'quack']
const VARIANT_LABEL = { base: 'Base', gold: 'Gold', gummy: 'Gum', galaxy: 'Gal', holofoil: 'Holo', cube: 'Cube', quack: 'Quack' }
